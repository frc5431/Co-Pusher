...
Draft3Validator = create(
    meta_schema=_utils.load_schema(os.path.dirname(os.path.abspath(__file__)) + "/schemas/draft3.json"),
    validators={
...
Draft4Validator = create(
    meta_schema=_utils.load_schema(os.path.dirname(os.path.abspath(__file__)) + "/schemas/draft4.json"),
    validators = {
        u"$ref": _validators.ref,
        u"additionalItems": _validators.additionalItems,
        u"additionalProperties": _validators.additionalProperties,
